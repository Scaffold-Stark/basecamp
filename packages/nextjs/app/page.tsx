				  ...
				  <div className="form-control">
					...
					<div className="bg-base-200 p-4 rounded-xl border-2 border-secondary">
					  <div className="flex flex-col space-y-4">
						{/* Some Option */}
						<label className="flex items-center gap-3 cursor-pointer" htmlFor="option-some">
						  <input 
							id="option-some"
						  ...
						  <div className="flex flex-col gap-1.5 w-full">
							<div className="flex items-center ml-2">
							  <span className="text-xs font-medium mr-2 leading-none">Some amount</span>
							</div>
							<div className="flex bg-base-300 text-accent rounded-lg">
							  <input
								...
								onChange={(e) => {
								  ...
								  if (value && value !== "") {
									try {
									  const amountInWei = BigInt(Math.floor(Number(value) * 10**18));
						...
						{/* None Option */}
						<label className="flex items-center gap-3 cursor-pointer" htmlFor="option-none">
						  <input 
							id="option-none"
							className="radio radio-xs radio-secondary" 
							type="radio" 
						  ...
						  <div className="flex flex-col gap-1.5 w-full">
							<div className="flex items-center ml-2">
							  <span className="text-xs font-medium mr-2 leading-none">No amount</span>
							</div>
